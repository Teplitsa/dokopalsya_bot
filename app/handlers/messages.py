...
async def process_start_command(message: Message) -> None:
    ...
    welcome_text = (
        ...
        "утверждений и текстов с помощью машинного обучения.\n\n"
        "<b>Что я умею:</b>\n"
        "• Проверяю утверждения, тексты и посты в Telegram на достоверность.\n"
        ...
        "Учти, что я работаю на базе машинного обучения и могу иногда ошибаться.\n\n"
...
async def process_info_command(message: Message) -> None:
    ...
    info_text = (
        "<b>Проект ФактЧекер</b> создан для повышения медиаграмотности и борьбы с"
        "медиа грамотности недостоверных сведений.\n\n"
        "<b>Цель проекта</b> — предоставить удобный инструмент для проверки фактов с помощью "
        "машинного обучения, чтобы каждый мог убедиться в достоверности информации и "
        ...
        "<b>NB!</b> Учти, что я работаю на базе машинного обучения и могу иногда ошибаться.\n\n"
